...
ClientMessageHandler::ClientMessageHandler(MessageHandler& mh): messageHandler(mh) {}
...
int ClientMesageHandler::deleteGroup(int groupId)  throw (ConnectionClosedException,
...
vector<string> ClientMessageHandler::listArticles(int groupId) throw (ConnectionClosedException, NewsGroupNonexistantException, ArticleNonexistantException, IllegalCommandException){
	...
	if (code != Protocol::ANS_ACK) {
		...
		if (code == Protocol::ERR_NG_DOES_NOT_EXIST) {
			throw NewsGroupNonexistantException();
		} else {
			throw ArticleDoesNonexistantException();
		}
...
vector<string> ClientMessageHandler::getArticle(int groupId, int articleId) throw (ConnectionClosedException, NewsGroupNonexistantException, ArticleNonexistantException, IllegalCommandException){
	...
	if (code != Protocol::ANS_ACK) {
		...
		if (code == Protocol::ERR_NG_DOES_NOT_EXIST) {
			...
			throw ArticleNonexistantException();
		}
	} else {
